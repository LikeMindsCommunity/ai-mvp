...
class CustomChatroomBuilder extends LMChatroomBuilderDelegate {
  ...
  PreferredSizeWidget appBarBuilder(
    ...
    return appBar.copyWith(
      ...
      //         LMChatSnackBar(content: LMChatText('Custom Settings Action!')),
      //       );
      //     },
      //   ),
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(title: 'LikeMinds Chat Demo', home: LoginScreen());
  }
}
        ...
        child: ElevatedButton(
          onPressed: () async {
            ...
            response = await LMChatCore.instance.showChatWithApiKey(
              ...
              uuid:
                  "YOUR_USER_UNIQUE_ID", // TODO: Replace with user's unique ID
